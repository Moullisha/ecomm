...
/**
 * Display products based on most popular and recently arrived
 * most sold products = /products?sortBy=sold&order=desc&limit=4
 * recently arrived = /products?sortBy=createdAt&order=desc&limit=4
 * if no params are set, all the products are returned
 */
...
/**
 * Finds products based on the requested product category
...
exports.listCategoryProducts = (req, res) => {
